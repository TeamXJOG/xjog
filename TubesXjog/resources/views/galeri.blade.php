...
@section('title', 'XJOG - Galeri')
@section('container')
    <!-- =========== CSS GALERI ============ -->
    <link href="https://fonts.googleapis.com/css?family=Josefin+Sans:300i,400,700" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('photon/fonts/icomoon/style.css')}}">

    <link rel="stylesheet" href="{{asset('photon/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('photon/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('photon/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('photon/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('photon/css/owl.theme.default.min.css')}}">

    <link rel="stylesheet" href="{{asset('photon/css/lightgallery.min.css')}}">    
    
    <link rel="stylesheet" href="{{asset('photon/css/bootstrap-datepicker.css')}}">

    <link rel="stylesheet" href="{{asset('photon/fonts/flaticon/font/flaticon.css')}}">
    
    <link rel="stylesheet" href="{{asset('photon/css/swiper.css')}}">

    <link rel="stylesheet" href="{{asset('photon/css/aos.css')}}">

    <link rel="stylesheet" href="{{asset('photon/css/style.css')}}">
<!-- =========== CSS GALERI ============ -->
