            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="about-us-content mb-80">
                        ...
                        <a href="#" data-toggle="modal" data-target="#staticBackdropMap" class="btn alime-btn btn-2 mt-30 wow fadeInUp">
                                                Lihat Peta </a>
                        ...
                        @if(\Session::get('role') == 'user')
                                    <a href="/uploadp/{{$event->id}}" class="btn alime-btn btn-2 mt-30 wow fadeInUp" data-wow-delay="500ms" >Ikut Kontes</a>
                                    @else
                                    <!-- Button trigger modal -->
                                    <a href="" data-toggle="modal" data-target="#staticBackdropAuth" class="btn alime-btn btn-2 mt-30 wow fadeInUp" data-wow-delay="500ms">
                                                Ikut Kontes
                                                </a>
                                    @endif   
                    </div>
...
<!-- Modal -->
<div class="modal fade" id="staticBackdropMap" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabelMap">Lokasi</h5>
      ...
      <div class="modal-body">
                    @php
                        $lokasi = $event->lokasiObjekwisata;
...
<!-- Modal -->
<div class="modal fade" id="staticBackdropAuth" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropAuthLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabelAuth">Log In Required</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
